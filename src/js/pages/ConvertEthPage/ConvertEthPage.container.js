...
export class ConvertEthPage extends React.Component {
    ...
    convertW2EAddress = (value) => value
    convertE2WAddress = (value) => value
            ...
            <div className="loaderWrapper">
                <div className="content card">
                    <div className="converter">
                        <ConverterItem title={labels.WAVES} convertedTitle={labels.ETHEREUM} handleConvert={this.convertW2EAddress}/>
                        <ConverterItem title={labels.ETHEREUM} convertedTitle={labels.WAVES} handleConvert={this.convertE2WAddress}/>
                    </div>
                    {/*<div className="converter">*/}
